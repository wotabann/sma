class RegisterHtml {
  ...
  get _html_id()                        { return $(this._html_body.find("#input-game-record-id")); }
  get _html_date()                      { return $(this._html_body.find("#input-game-record-date")); }
  get _html_rate()                      { return $(this._html_body.find("#input-game-record-rate")); }
  get _html_stock()                     { return $(this._html_body.find("#input-game-record-stock")); }
  get _html_fighter()                   { return $(this._html_body.find("#input-game-record-fighter")); }
  get _html_is_vip()                    { return $(this._html_body.find("#input-game-record-is-vip")); }
