class Registerer {
  ...
  constructor() {
    ...
    this._registerHtml    = new RegisterHtml($("#register"), fighterListHtml);
   ...
   * @param {GameRecord} gameRecord
   */
  async gameRecordRowOnClick(gameRecord) {
  ...
  async _insertUpdate(isDump) {
    ...
    if (isDump) {
      ...
      // 戦績の更新
      var gameRecordRowOnClick = this.gameRecordRowOnClick.bind(this);
